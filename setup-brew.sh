...
brew install --cask \
    ...
    microsoft-onenote mongodb-compass musicbrainz-picard netnewswire skim pika \
    ...
    alt-tab another-redis-desktop-manager audacity ghostty xld openineditor-lite